...
(function() {
    ...
    var isEmpty, uniqueKey;
    if ('undefined' !== typeof JSUS) {
        isEmpty = JSUS.isEmpty;
        uniqueKey = JSUS.uniqueKey;
    }
    else {       
        ({ uniqueKey, isEmpty } = require('./obj'));
    }
    ...
    Queue.prototype.isReady = function() {
        return isEmpty(this.inProgress);
    };
    ...
    Queue.prototype.add = function(key) {
        ...
        key = uniqueKey(this.inProgress, key);
