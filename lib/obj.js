...
(function(JSUS) {
     ...
     *
     * Supports other types: undefined, null, string, number
     * are always false. Functions and array are checked.
     *
     * Notice: this is much faster than Object.keys(o).length === 0;
     * because it does pull out all keys.
     *
    ...
    OBJ.isEmpty = function(o) {
        ...
        if ('string' === typeof o) return true;
        if ('number' === typeof o) return true;
        for (key in o) {
