...
(function(JSUS) {
    ...
    DOM.add = DOM.append = function(name, root, options) {
        ...
        if (attributes) {
            if (attributes.insertBefore) {
                if (attributes.insertAfter) {
                    throw new Error('DOM.add: attributes.insertBefore and ' +
                                    'attributes.insertBefore cannot be ' +
                                    'both set.');                
                }
                if (!root.parentNode) {
            ...
            else if (attributes.insertAfter) {
                if (!root.parentNode) {
                    throw new Error('DOM.add: root.parentNode not found. ' +
                                    'Cannot insert before.');
                }
     ...
     * @see DOM.addAttributes
     */
    function getLabel(text, forElem) {
        var label, forId;
        if ('string' !== typeof text) {
            throw new TypeError('DOM.get: label text must be string. Found: ' +
                                text);
        }
        ...
        if (forElem) {
            if ('string' === typeof forElem) {
                ...
                throw new TypeError('DOM.get: label forElem must be ' +
